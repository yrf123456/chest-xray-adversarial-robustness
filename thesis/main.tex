...
% Custom commands
\newcommand{\projecttitle}{Evaluating Adversarial Robustness in Medical Image Classification}
...
\begin{appendices}
    ...
    The complete source code for this project, including attack implementations, evaluation scripts, and visualization tools, is publicly available:
    
    \textbf{GitHub:} \url{https://github.com/yrf123456/chest-xray-adversarial-robustness}
    
    \textbf{OneDrive:} \url{https://dmail-my.sharepoint.com/:f:/g/personal/2542795_dundee_ac_uk/IgBxjFimW1FmTLuQYnPaHddnAbNig230y1kgNWRn8ZrjqXA?e=D6e5PL}
